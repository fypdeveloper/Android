...
//    private String URL_FEED = "https://api.androidhive.info/feed/feed.json";
    private String URL_FEED = "http://192.168.137.1:8000/api/getProjects";
        ...
        if (entry != null) {
            ...
            JsonObjectRequest jsonReq = new JsonObjectRequest(Method.GET,
                ...
                public void onResponse(JSONObject response) {
                    try {
                        Log.d("OKOK", response.getJSONArray("feed").get(0).toString());
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
    ...
    private void parseJsonFeed(JSONObject response) {
        ...
        try {
            ...
            for (int i = 0; i < feedArray.length(); i++) {
                ...
                item.setName(feedObj.getString("type"));
                ...
                item.setProfilePic(feedObj.getString("img"));
                item.setTimeStamp(feedObj.getString("created_at"));

                // url might be null sometimes
                String feedUrl = feedObj.isNull("title") ? null : feedObj
                        .getString("title");
                item.setUrl(feedUrl);
